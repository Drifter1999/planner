...
import com.codingbox.planner.domain.DTO.RestaurantDetailDTO;
...
public class RestaurantService {
    public List<RestaurantDetailDTO> getApiResponse(String contentId, String contentTypeId) {
...
// HTTP Header 객체 생성 및 설정
            ...
            List<RestaurantDetailDTO> resultList = new ParsingToList().findRestIntroArray(jsonArr);
            return resultList;
        }catch (Exception e){
            e.printStackTrace();
        }
