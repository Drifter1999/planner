...
import com.codingbox.planner.domain.DTO.LeisureDetailIntroDTO;
...
public class LeisureService {
    public List<LeisureDetailIntroDTO> getApiResponse(String contentId, String contentTypeId) {
...
// HTTP Header 객체 생성 및 설정
            ...
            List<LeisureDetailIntroDTO> resultList = new ParsingToList().findLeisureIntroArray(jsonArr);
            return resultList;
        }catch (Exception e){
            e.printStackTrace();
        }
