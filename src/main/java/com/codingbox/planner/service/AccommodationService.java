...
public class AccommodationService {
    public List<AccommodationDetailIntroDTO> getApiResponse(String contentId, String contentTypeId) {
...
// HTTP Header 객체 생성 및 설정
            ...
            List<AccommodationDetailIntroDTO> resultList = new ParsingToList().findAccomIntroArray(jsonArr);
